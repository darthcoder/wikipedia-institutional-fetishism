...
Provide the WWI corpus as `data/wwi_extended.jsonl` (JSONL format with `{pageid, title, wikitext}` schema). If working with the parent `ner-paper` project, copy or symlink:

```bash
ln -s ../../ner-paper/data/wwi_extended.jsonl data/wwi_extended.jsonl
```
...
**GitHub**: https://github.com/darthcoder/wif  
**Documentation**: See `CLAUDE.md` for development setup, common tasks, and troubleshooting.

For detailed developer guidance, methodology, and reproducibility notes, see:
- `CLAUDE.md` — Development guide and architecture
- `wikipedia-institutional-fetishism_1.md` — Formal write-up with full analysis
- `wikipedia-fetish-vault-staging.md` — Extended theoretical commentary
